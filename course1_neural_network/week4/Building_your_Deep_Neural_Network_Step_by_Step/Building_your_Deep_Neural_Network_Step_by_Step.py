...
def initialize_parameters(n_x, n_h, n_y):
    ...
    parameters -- python dictionary containing your parameters:
                    ...
                    b1 -- bias vector of shape (n_h, 1)  zeros
...
def test_linear_forward():
    ...
    print('A = ' + str(A) + ': ' + str(A.shape))
    print('W = ' + str(W) + ': ' + str(W.shape))
    print('b = ' + str(b) + ': ' + str(b.shape))
    Z, linear_cache = linear_forward(A, W, b)
    print("Z = " + str(Z))
    print(str(linear_cache))
...
def linear_backward(dZ, cache):
    ...
    # print('cache[0] ' + str(cache[0].shape))
    # print('cache[1] ' + str(cache[1].shape))
    # print('cache[2] ' + str(cache[2].shape))
...
if __name__ == "__main__":
    ...
    # test_initialize_parameters_deep()
    # test_linear_forward()

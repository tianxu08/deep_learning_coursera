...
def test_initialize_parameters_zeros():
...
def test_initialize_parameters_random():
...
'''
Observations:
The model with He initialization separates 
the blue and the red dots very well in a small number of iterations.
'''
...
if __name__ == "__main__":
    # test_initialize_parameters_zeros()
    # test_models_zeros()
    # test_initialize_parameters_random()
    # test_models_random()
    # test_initialize_parameters_he()
    test_models_he()

...
def update_parameters_with_adam(parameters, grads, v, s, t, learning_rate = 0.01,
    ...
    for l in range(L):
        ...
        v["db" + str(l+1)] = beta1 * v["dW" + str(l+1)] + (1 - beta1) * grads["dW" + str(l + 1)]
        ### END CODE HERE ###
...
if __name__ == "__main__":
    # test_update_parameters_with_gd()
    # test_random_mini_batches()
    # test_initialize_velocity()
    # test_update_parameters_with_momentum()
    # test_initialize_adam()
    # test_update_parameters_with_adam()
    # mini_batch_with_gradient()
    # mini_batch_gradient_descent_with_momentum()
    mini_batch_with_adam_mode()
